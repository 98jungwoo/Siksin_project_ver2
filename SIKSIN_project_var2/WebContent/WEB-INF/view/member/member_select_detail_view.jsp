				...
				<div class="row" id="member#ffffff">
					<div class="col-md-12">
						<fieldset name="member" class="member">
							<h3 class="fieldset_h3">회원정보 상세</h3>
							<form action="./SiksinSelectDetail.do" method="post"
								...
								<div class="row form-group">
									...
									<div class="col-md-12" id="id" style="display: none;">
										<label class="member_label" for="memberName">번호<em>*</em></label> <input type="text"
											id="memberNum" name="memberNum" class="form-control" value="${memberDTO.memberNum}"
											readonly>
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="nickName">닉네임<em>*</em></label> <input type="text"
											id="nickName" name="nickName" class="form-control" value="${memberDTO.nickName}" readonly>
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="gender">성별</label><br>
										<c:choose>
											<c:when test="${memberDTO.gender == '여자'}">
												<input type="text" class="form-control" name="여자" id="여자" value="${memberDTO.gender}"
													readonly>
											</c:when>
											<c:otherwise>
												<input type="text" class="form-control" name="남자" id="남자" value="${memberDTO.gender}"
													readonly>
											</c:otherwise>
										</c:choose>
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										<input type="text" name="phoneNum" id="phoneNum" class="form-control"
											value="${memberDTO.phoneNum}" readonly>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="memberArea">사는지역</label> <input type="text"
											name="memberArea" id="memberArea" class="form-control" value="${memberDTO.memberArea}"
											readonly>
									</div>
								</div>
								<hr>
								<div class="form-group">
									<div class="member_button">
										<nav class="navbar justify-content-end">
											<div class="btn-group">
												<button type="button" class="btn btn-outline-info mr-sm-1" onclick="memberUpdate()">
													<i class="fas fa-user-edit mr-sm-1"></i>회원 수정
												</button>
											</div>
											<div class="btn-group">
												<button type="button" class="btn btn-outline-info mr-sm-1" onclick="memberDelete()">
													<i class="fas fa-user-edit mr-sm-1"></i>회원 탈퇴
												</button>
											</div>
											<div class="btn-group">
												<button type="button" class="btn btn-outline-info mr-sm-1"
													onclick="location.href='./SiksinSelect.do'">
													<i class="fas fa-user-edit mr-sm-1"></i>회원 목록
												</button>
											</div>
										</nav>
