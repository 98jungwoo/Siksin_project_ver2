...
<script type="text/javascript">
	...
	function memberUpdate() {
		if (confirm("${memberDTO.memberName}님 회원정보를 수정 하시겠습니까?")) {
...
<body>
	...
	<div id="page">
					...
					<div class="col-md-12 col-md-offset-0 text-center">
						...
						<div class="row row-mt-15em">
							<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
								<span class="intro-text-small"> <a href="index.html" target="_blank">대한민국 No.1 맛집
										서비스 siksin. 회원정보수정</a></span>
		...
		<div class="gtco-section" id="update_member" name="update_member">
			<div class="gtco-container">
				<div class="row" id="member#ffffff">
					<div id="buttonUpdatDeleteview" class="mx-auto">
						...
						<ul class="authcd_y" id="authcd_y_all">
							<li class="on col-md-6" id="authcd_y1" onclick="memberUpdate()"><a>회원정보변경</a></li>
							<li class="false col-md-6" id="authcd_y2" onclick="memberDelete()"><a>회원탈퇴</a></li>
						</ul>
					</div>
					<fieldset name="member" class="member">
						<h3 class="fieldset_h3">회원정보수정</h3>

						<form action="./SiksinUpdateView.do?memberNum=${memberDTO.memberNum}" method="post" enctype="application/x-www-form-urlencoded">
							...
							<div class="row form-group">
								...
								<div class="col-md-12">
									<label class="member_label" for="memberName">이름<em>*</em></label> <input type="text"
										id="memberName" name="memberName" class="form-control" value="${memberDTO.memberName}"
										readonly>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="member_label" for="nickName">닉네임<em>*</em></label> <input type="text"
										id="nickName" name="nickName" class="form-control" value="${memberDTO.nickName}">
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="member_label" for="password">비밀번호<em>*</em></label> <input
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="member_label" for="memberBirth">생년월일</label> <input type="date"
										name="memberBirth" id="memberBirth" class="form-control" value="${memberDTO.memberBirth}"
										readonly>
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="member_label" for="gender">성별</label><br> <input class="member_label"
										type="radio" name="gender" id="gender" value="여자"> 여자 <input class="member_label"
							...
							<div class="row form-group">
								<div class="col-md-4">
									<select name="phoneNumArea" id="phoneNumArea" class="form-control">
								...
								<div class="col-md-6">
									<input type="text" name="phoneNum" id="phoneNum" class="form-control"
										value="${memberDTO.phoneNum}">
								</div>
								<input class="button11" type="button" onclick="alert('인증번호를 발송하였습니다.')" value="인증번호 발송">
							</div>
							<div class="row form-group">
								<div class="col-md-4">
									<label class="sr-only" for="phoneNum2">인증번호</label> <input type="text" size="20"
										name="phoneNum2" id="phoneNum2" class="form-control" placeholder="인증번호를 입력해주세요">
								</div>
								<input class="button11" type="button" value="확인" onclick="alert('인증이 완료되었습니다.')">
							</div>
							<div class="row form-group">
								<div class="col-md-12">
									<label class="member_label" for="memberArea">사는지역</label> <select name="memberArea"
										id="memberArea" class="form-control">
							...
							<div class="checkbox_group">
								<div class="checkbox">
									<!-- 수정불가이기 때문에 보이지 않게 함 -->
									<input type="checkbox" name="agree" id="agree1" value="이용약관동의" class="nomal" checked
										style="display: none;">[필수] 이용약관 동의<em>*</em> <br> <input type="checkbox"
										style="display: none;" name="agree" id="agree2" value="개인정보수집동의" class="nomal" checked
										style="display: none;">[필수] 개인정보 수집 및 이용에 동의<em>*</em><br> <input
										type="checkbox" name="agree" id="agree3" value="만14세 이상" class="nomal" checked
										style="display: none;">[필수] 만 14세 이상<em>*</em> <br> <input type="checkbox"
										name="agree" id="agree4" value="위치기반동의" class="nomal" checked>[선택] 위치기반 서비스 이용약관에
									동의<br> <input type="checkbox" name="agree" id="agree5" value="마케팅동의" class="nomal"
										checked>[선택] 마케팅/홍보 정보제공을 위한 개인정보 수집(문자)<br>
								</div>
								<div class="checkbox">
									<div class="agreebox">
										- 광고 정보 수신동의를 하시면 상품 및 이벤트 정보를 받으실 수 있습니다.<br> - 서비스의 중요 안내사항 정보는 위 수신 여부와 상관없이
										발송됩니다.
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="member_button">
									<button type="button" class="btn btn-primary" id="submit"
										onclick="location.href='./SiksinSelect.do'">회원 정보</button>
 									 <button type="button" class="btn btn-primary" id="submit" 
											onclick="location.href='./SiksinUpdateView.do?memberNum=${memberDTO.memberNum}'">회원 수정</button>
									<!--  <button type="submit" class="btn btn-primary" id="submit" >회원 수정</button> -->
									<button type="reset" class="btn btn-primary" id="update_reset">수정 취소</button>
								</div>
							</div>
						</form> 
					</fieldset>
