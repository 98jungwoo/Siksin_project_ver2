...
<body>
	...
	<div id="page">
		...
		<div class="gtco-section" id="join_member" name="join_member">
			<div class="gtco-container">
				<div class="row" id="member#ffffff">
					<div class="col-md-12">
						<fieldset name="member" class="member">
							<h3 class="fieldset_h3">회원가입</h3>
							<form action="./SiksinInsert.do" method="post" enctype="application/x-www-form-urlencoded">
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="memberName">이름<em>*</em></label> <input type="text"
											id="memberName" name="memberName" class="form-control" placeholder="이름을 입력해주세요.">
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="nickName">닉네임<em>*</em></label> <input type="text"
											id="nickName" name="nickName" class="form-control" placeholder="닉네임을 입력해주세요">
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<div class="input2">* 2~20자 영문문자, 숫자, 특수문자를 사용하세요.</div>
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="memberBirth">생년월일</label> <input type="date"
											name="memberBirth" id="memberBirth" class="form-control">
								...
								<div class="checkbox_group">
									...
									<div class="checkbox">
										...
										<input type="checkbox" name="agree" id="agree1" value="이용약관동의" class="nomal" checked>[필수]
										이용약관 동의<em>*</em> <br> <input type="checkbox" name="agree" id="agree2"
											value="개인정보수집동의" class="nomal" checked>[필수] 개인정보 수집 및 이용에 동의<em>*</em><br> <input
											type="checkbox" name="agree" id="agree3" value="만14세 이상" class="nomal" checked>[필수]
										만 14세 이상<em>*</em> <br> <input type="checkbox" name="agree" id="agree4"
											value="위치기반동의" class="nomal" checked>[선택] 위치기반 서비스 이용약관에 동의<br> <input
											type="checkbox" name="agree" id="agree5" value="마케팅동의" class="nomal" checked>[선택]
										마케팅/홍보 정보제공을 위한 개인정보 수집(문자)<br>
									</div>
								...
								<div class="form-group">
									<div class="member_button">
										<input type="submit" class="btn btn-primary" id="submit" value="가입하기"> <input
											type="reset" class="btn btn-primary" id="reset" value="취소하기">
									</div>
								</div>
