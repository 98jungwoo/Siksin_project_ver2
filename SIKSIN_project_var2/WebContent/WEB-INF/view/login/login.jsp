...
<title>SIKSIN &mdash;login</title>
...
<script src="./js/siksin_member.js" type="text/javascript"></script>
						...
						<div class="row row-mt-15em">
							<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
								<span class="intro-text-small"> <a href="index.html" target="_blank">대한민국 No.1 맛집
										서비스</a></span>
								<h1 class="cursive-font">Welcome to the SIKSIN!</h1>
							</div>
											...
											<form action="./Login.do" method="post" name="login" id="login"
												...
												<div class="tab-content-inner active" data-content="signup">
													...
													<div class="row form-group">
														<div class="col-md-12">
															<label for="phoneNumArea">PhoneNumber</label> <select name="phoneNumArea"
																id="phoneNumArea" class="form-control">
																...
																<!-- 전호번호 로그인 -->
															</select> <input type="text" id="phoneNum" name="phoneNum" class="form-control">
														</div>
													</div>
												</div>
												<div class="row form-group">
												...
												<div class="custom-control custom-checkbox">
													<input type="checkbox" name="save" class="custom-control-input" id="save"> <label
														class="custom-control-label" for="save">로그인 상태 유지</label>
												</div>

												<div class="row form-group">
													<ul>
														<!-- 여기 회원가입 페이지 링크넣기 href="" -->
														<li><a onclick="location.href='./PasswordSearchView.do'">비밀번호 찾기&nbsp;</a> <a
															onclick="location.href='./SiksinInsertView.do'">|&nbsp;&nbsp;회원가입 하기</a></li>
													</ul>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
