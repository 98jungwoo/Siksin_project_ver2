...
<title>SIKSIN &mdash;index</title>
					...
					<div class="col-md-12 col-md-offset-0 text-left">
						...
						<div class="row row-mt-15em">
							<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
								<span class="intro-text-small"> <a href="./index.jsp" target="_blank">대한민국 No.1
										맛집 서비스</a></span>
									...
									<div class="tab">
										<div class="tab-content">
											<div class="tab-content-inner active" data-content="signup">
												...
												<!-- 버튼1 -->
												<h3 class="cursive-font">membership</h3>
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block"
															onclick="location.href='./SiksinSelect.do'" value="회원 관리">
													</div>
												</div>
													...
													<c:choose>
														<c:when test="${empty sessionScope.phoneNum}">
															...
															<div class="row form-group">
																<div class="col-md-12">
																	<input type="submit" class="btn btn-primary btn-block"
																		onclick="location.href='./LoginView.do'" value="로그인">
																</div>
															</div>
														</c:when>
														<c:otherwise>
															<h3 class="cursive-font">Logout</h3>
															<div class="row form-group">
																<div class="col-md-12">
																	<input type="submit" class="btn btn-primary btn-block"
